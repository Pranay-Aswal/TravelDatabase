...
INNER JOIN customer_details ON bookings.user_uniqueID=customer_details.unique_id)  where trip_details.Date <= CURDATE() and trip_details.Start_time < CURTIME() and email_id=:eid";
